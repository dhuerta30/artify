...
function insertar_modulos($data, $obj, $id_sesion_usuario = null) {
    ...
    $query_db = isset($data["modulos"]["query"]) ?? null;
    ...
    $mostrar_campos_filtro = isset($data["modulos"]["mostrar_campos_filtro"]) ?? null;
    ...
    $actions_buttons_grid = isset($data["modulos"]["actions_buttons_grid"]) ?? null;
    $activate_nested_table = $data["modulos"]["activate_nested_table"];
    $buttons_actions = isset($data["modulos"]["buttons_actions"]) ?? null;
    $refrescar_grilla = $data["modulos"]["refrescar_grilla"];
    $encryption = $data["modulos"]["encryption"];
    $mostrar_campos_busqueda = isset($data["modulos"]["mostrar_campos_busqueda"]) ?? null;
    $mostrar_columnas_grilla = isset($data["modulos"]["mostrar_columnas_grilla"]) ?? null;
    $mostrar_campos_formulario = isset($data["modulos"]["mostrar_campos_formulario"]) ?? null;
    ...
    $tabla_principal_union = isset($data["modulos"]["tabla_principal_union"]) ?? null;
    $tabla_secundaria_union = isset($data["modulos"]["tabla_secundaria_union"]) ?? null;
    $campos_relacion_union_tabla_principal = isset($data["modulos"]["campos_relacion_union_tabla_principal"]) ?? null;
    $campos_relacion_union_tabla_secundaria = isset($data["modulos"]["campos_relacion_union_tabla_secundaria"]) ?? null;

    $mostrar_campos_formulario_editar = isset($data["modulos"]["mostrar_campos_formulario_editar"]) ?? null;
    ...
    $cantidad_de_registros_por_pagina = isset($data["modulos"]["cantidad_de_registros_por_pagina"]) ?? null;
    $activar_edicion_en_linea = isset($data["modulos"]["activar_edicion_en_linea"]) ?? null;
    $nombre_modulo = isset($data["modulos"]["nombre_modulo"]) ?? null;
    $ordenar_grilla_por = isset($data["modulos"]["ordenar_grilla_por"]) ?? null;
    $tipo_orden = isset($data["modulos"]["tipo_orden"]) ?? null;
    $posicionarse_en_la_pagina = isset($data["modulos"]["posicionarse_en_la_pagina"]) ?? null;
    $ocultar_id_tabla = $data["modulos"]["ocultar_id_tabla"];
    $nombre_columnas = isset($data["modulos"]["nombre_columnas"]) ?? null;
    $nuevo_nombre_columnas = isset($data["modulos"]["nuevo_nombre_columnas"]) ?? null;
    $nombre_campos = isset($data["modulos"]["nombre_campos"]) ?? null;
    $nuevo_nombre_campos = isset($data["modulos"]["nuevo_nombre_campos"]) ?? null;
    $tipo_de_filtro = isset($data["modulos"]["tipo_de_filtro"]) ?? null;
    $totalRecordsInfo = $data["modulos"]["totalRecordsInfo"];
    $area_protegida_por_login = $data["modulos"]["area_protegida_por_login"];
    $posicion_filtro = !empty($data["modulos"]["posicion_filtro"]) ?? null;
    $file_callback = !empty($data["modulos"]["file_callback"]) ?? null;
    $type_callback = isset($data["modulos"]["type_callback"]) ?? null;

    $activate_pdf = $data["modulos"]["activate_pdf"];
    $logo_pdf = isset($data["modulos"]["logo_pdf"]) ?? null;
    $marca_de_agua_pdf = isset($data["modulos"]["marca_de_agua_pdf"]) ?? null;
    $consulta_pdf = isset($data["modulos"]["consulta_pdf"]) ?? null;
