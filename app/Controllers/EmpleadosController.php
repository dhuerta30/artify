        ...
        class EmpleadosController
        {
            ...
            public function index()
            {
                ...
                unset($columnDB[0]);
                        ...
                        $artify->editFormFields(array("id_empleados", "nombre_empleado", "apellido_empleado", "fecha_nacimiento_empleado"));
                    

                        $valuesArray = array("nombre_empleado", "apellido_empleado");
                        ...
                        foreach ($valuesArray as $column) {
                            ...
                            $artify->setFilterSource('filterAdd'.$column, 'empleados', $column, $column.' as pl', 'db');
                        }
