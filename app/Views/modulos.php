...
$(document).on("artify_after_ajax_action", function(event, obj, data){
    ...
    if(dataAction == "add"){
        ...
        $(function() {
            var textosPermitidosList = ['Imagen', 'Archivo Único', 'Multiples Archivos', 'Radiobox', 'Checkbox', 'Combobox', 'Combobox Multiple', 'Campo de Texto', 'Campo de Fecha', 'Campo de Fecha y Hora', 'Campo de Hora'];
